...
public class ModelLightJet extends TronModel
{
	public Entity Jet;
	...
	public void render(ItemStack item)
	{
		...
		if (ItemUpgradeHelper.doesItemHaveUpgrade(item, Upgrade.LightJetAgility) != 0)
		{
			backleftwingbottom.render(f5);
			backrightwingbottom.render(f5);
			WingEndleftbackbottom.render(f5);
		...
		if (ItemUpgradeHelper.doesItemHaveUpgrade(item, Upgrade.LightJetQuadGun) != 0)
		{
			LeftWingGun.render(f5);
			RightWingGun.render(f5);
		}
