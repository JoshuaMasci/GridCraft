...
public class ModelLaser extends ModelBase
{
	...
	public ModelLaser()
	{
		renderTexture = "/mods/GridCraft/textures/Laser.png";
	...
	public void render()
	{
		...
		if (missile.rotateAngleX > 2 * PI)
			missile.rotateAngleX -= 2 * PI;
	...
	public void update()
	{
		...
		deltaTime = ((float) (time - prevTime)) / 1000000000f; // divide by a
																// billion to
																// convert to
																// sec
		...
		else if (entityPrevTime > prevTime)
		{
			...
			float adjustedDeltaTime = ((float) (time - entityPrevTime)) / 1000000000f; // divide
																						// by
																						// a
																						// billion
																						// to
		...
		GL11.glRotatef(-90f - rotationYaw, 0.0f, 1.0f, 0.0f); // why -90
																// adjustment?
