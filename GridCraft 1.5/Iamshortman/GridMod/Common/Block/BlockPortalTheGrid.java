...
import Iamshortman.GridMod.Common.TheGrid.TeleporterGrid;
...
public class BlockPortalTheGrid extends BlockPortal
{
	public BlockPortalTheGrid(int id)
	{
		super(id);
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
		{
			if (par5Entity instanceof EntityPlayerMP)
			{
				...
				if (par5Entity.dimension != GridCraft.dimension)
				{
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, GridCraft.dimension, new TeleporterGrid(thePlayer.mcServer.worldServerForDimension(GridCraft.dimension)));
					System.out.println("Taking " + thePlayer.username + " to the Grid");
					//thePlayer.playerNetServerHandler.setPlayerLocation(0, 100, 0, thePlayer.rotationYaw, thePlayer.rotationPitch);
				}
				else
				{
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterGrid(thePlayer.mcServer.worldServerForDimension(0)));
				}
			}
		}
	}
