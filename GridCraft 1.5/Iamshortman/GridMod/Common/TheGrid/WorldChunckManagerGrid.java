...
public class WorldChunckManagerGrid extends WorldChunkManager
{
    public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(forest, plains, taiga, taigaHills));
    ...
    protected WorldChunckManagerGrid()
    {
    ...
    public WorldChunckManagerGrid(long par1, WorldType par3WorldType)
    {
        this();
        GenLayer[] agenlayer = GenLayerGrid.initializeAllBiomeGenerators(par1, par3WorldType);

        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public WorldChunckManagerGrid(World par1World)
    {
