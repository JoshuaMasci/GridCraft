...
public class TeleporterGrid extends Teleporter
{
	...
	public TeleporterGrid(WorldServer par1WorldServer)
	{
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
			{
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
				{
					...
					{
						if (this.field_85192_a.getBlockId(var48, var26, var23) == GridCraft.portal.blockID)
						{
							while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == GridCraft.portal.blockID)
							{
								--var26;
							}
		...
		if (var10 >= 0.0D)
		{
			...
			if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == GridCraft.portal.blockID)
			{
				var50 = 2;
			}
			...
			if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == GridCraft.portal.blockID)
			{
				var50 = 3;
			}
		...
		for (var19 = 0; var19 < 4; ++var19)
		{
			...
			for (var20 = 0; var20 < 4; ++var20)
			{
				for (var21 = -1; var21 < 4; ++var21)
				{
					...
					this.field_85192_a.setBlock(var22, var23, var24, var33 ? Block.sandStone.blockID : GridCraft.portal.blockID);
				}
			}
